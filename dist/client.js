...
Linting.prototype._formatIssues = function(issues) {
  ...
  let reports = (0,min_dash__WEBPACK_IMPORTED_MODULE_1__.reduce)(issues, function(reports, ruleReports, rule) {
  ...
  reports = (0,min_dash__WEBPACK_IMPORTED_MODULE_1__.map)(reports, function(report) {
  ...
  reports = (0,min_dash__WEBPACK_IMPORTED_MODULE_1__.groupBy)(reports, function(report) {
    return report.id;
  });
...
Linting.prototype.update = function() {
  ...
  this.lint().then(function(newIssues) {
    ...
    remove = (0,min_dash__WEBPACK_IMPORTED_MODULE_1__.assign)(remove, update);
    add = (0,min_dash__WEBPACK_IMPORTED_MODULE_1__.assign)(add, update);
...
Linting.prototype._createElementIssues = function(elementId, elementIssues) {
  ...
  var issuesByType = (0,min_dash__WEBPACK_IMPORTED_MODULE_1__.groupBy)(elementIssues, function(elementIssue) {
  ...
  var $icon = (errors || childErrors)
    ? (0,min_dom__WEBPACK_IMPORTED_MODULE_2__.domify)('<div class="bjsl-icon bjsl-icon-error">' + ErrorSvg + '</div>')
    : (0,min_dom__WEBPACK_IMPORTED_MODULE_2__.domify)('<div class="bjsl-icon bjsl-icon-warning">' + WarningSvg + '</div>');

  var $dropdown = (0,min_dom__WEBPACK_IMPORTED_MODULE_2__.domify)('<div class="bjsl-dropdown"></div>');
  var $dropdownContent = (0,min_dom__WEBPACK_IMPORTED_MODULE_2__.domify)('<div class="bjsl-dropdown-content"></div>');

  var $issueContainer = (0,min_dom__WEBPACK_IMPORTED_MODULE_2__.domify)('<div class="bjsl-issues"></div>');

  var $issues = (0,min_dom__WEBPACK_IMPORTED_MODULE_2__.domify)('<div class="bjsl-current-element-issues"></div>');
  var $issueList = (0,min_dom__WEBPACK_IMPORTED_MODULE_2__.domify)('<ul></ul>');
  ...
  if (childErrors || childWarnings) {
    var $childIssues = (0,min_dom__WEBPACK_IMPORTED_MODULE_2__.domify)('<div class="bjsl-child-issues"></div>');
    var $childIssueList = (0,min_dom__WEBPACK_IMPORTED_MODULE_2__.domify)('<ul></ul>');
    var $childIssueLabel = (0,min_dom__WEBPACK_IMPORTED_MODULE_2__.domify)('<a class="bjsl-issue-heading">Issues for child elements:</a>');
    ...
    if (errors || warnings) {
      var $childIssuesSeperator = (0,min_dom__WEBPACK_IMPORTED_MODULE_2__.domify)('<hr/>');
...
Linting.prototype._addEntry = function($ul, state, entry) {
  ...
  var $entry = (0,min_dom__WEBPACK_IMPORTED_MODULE_2__.domify)(
    '<li class="' + state + '">' +
      '<span class="icon"> ' + icon + '</span>' +
      '<a title="' + (0,diagram_js_lib_util_EscapeUtil__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(rule) + ': ' + (0,diagram_js_lib_util_EscapeUtil__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(message) + '" ' +
         'data-rule="' + (0,diagram_js_lib_util_EscapeUtil__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(rule) + '" ' +
         'data-message="' + (0,diagram_js_lib_util_EscapeUtil__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(message) + '"' +
      '>' +
        (0,diagram_js_lib_util_EscapeUtil__WEBPACK_IMPORTED_MODULE_3__.escapeHTML)(message) +
      '</a>' +
      (actualElementId
...
Linting.prototype._createButton = function() {
  ...
  this._button = (0,min_dom__WEBPACK_IMPORTED_MODULE_2__.domify)(
...
(0,camunda_modeler_plugin_helpers__WEBPACK_IMPORTED_MODULE_0__.registerClientPlugin)(config => {
